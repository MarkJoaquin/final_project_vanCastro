...
const BookingForm = () => {
    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            ...
            // Simulate a delay to show the loading spinner (can be removed in production)
                ...
                <>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {hasLearnerPermit === 'yes' && (
                                            <div className="mt-4">
                                                            ...
                                                            onChange={(e) => {
                                                                if (e.target.files && e.target.files[0]) {
                                                                    ...
                                                                    if (file.type.startsWith('image/')) {
                                                                        ...
                                                                        setFileUploadError('Please select a valid image file (JPEG, PNG, or GIF)');
                                                ...
                                                {fileUploadError && (
                                                    <div className="mt-4 p-3 bg-red-50 text-red-700 rounded-md border border-red-200 flex items-center animate-fade-in">
                    ...
                    {showConfirmation && (
                        <ConfirmationModal
                            ...
                            onConfirm={() => {
                                // Don't close the modal immediately - the onSubmit function will handle closing it
                        ...
                        <div className="mt-4 space-y-4">
                            <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded relative mb-4">
                                <div className="flex items-center">
                                    <div className="mr-3 animate-bounce">

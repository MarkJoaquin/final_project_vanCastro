    ...
    return (
        <section className={styles.ourStorySection}>
            <div className={styles.ourStory}>
                ...
                <div className={`${styles.title} ${styles.slideUp}`}>
                <h3>Our Story</h3>
                <div className={styles.span}></div>
                </div>

                <div className={`${styles.images} ${styles.slideUp}`}>
                <Image
                ...
                <div className={styles.infoSide}>
                    <div className={` ${styles.storyText} ${styles.slideUp}`}>
                        <p>
                    ...
                    <div className={styles.cardsContainer}>
                        <div className={`${styles.cards} ${styles.slideUp}`}>
                            <h2>100+</h2>
                            <p>Google reviews</p>
                        </div>
                        <div className={`${styles.cards} ${styles.slideUp}`}>
